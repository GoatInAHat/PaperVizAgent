...
"""Hermes plugin for papervizagent, registered through PluginContext.
...
from papervizagent.ops import OPERATIONS as AUTHORED_OPERATIONS
from papervizagent.toolfactory.config import context
from papervizagent.toolfactory.web import OPERATION as WEB_OPERATION
from pydantic import BaseModel

TOOLSET = "papervizagent"
REQUIRES_ENV = []
TOOLS = json.loads(
    r"""[
  {
...
def register(ctx: Any) -> None:
    ...
    os.environ.setdefault("PAPERVIZAGENT_DATA_DIR", str(ctx.state.data_dir))
    for schema in TOOLS:
        ctx.register_tool(
            name=schema["name"],
            toolset=TOOLSET,
