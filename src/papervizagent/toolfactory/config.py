...
def data_dir() -> Path:
    """Where this tool may keep its own state: PAPERVIZAGENT_DATA_DIR when a host sets it, else the
    ...
    configured = (
        os.environ.get("PAPERVIZAGENT_DATA_DIR")
    ...
    return base / "papervizagent"


def context() -> Context:
    return Context(config={
            "papervizagent_config": os.environ.get("PAPERVIZAGENT_CONFIG"),
