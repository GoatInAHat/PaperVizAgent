...
.PHONY: prepare build check validate package
...
package: prepare
	...
	zip -qr dist/release/papervizagent-codex-plugin.zip skills .codex-plugin .agents/plugins LICENSE NOTICE UPSTREAM.json
